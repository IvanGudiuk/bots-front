  ...
  return (
    <div className={css.wrapper}>
      ...
      <p className={css.text}>
        ...
        наблюдается разворот локального тренда. Данные предоставляются для
        15-минутного таймфрейма и основаны на информации о{" "}
        <span className={css.highlight}>фьючерсах (бессрочных USDT)</span>.
      </p>
      <h3 className={css.name}>Как понимать сигналы бота?</h3>
      <p className={css.head}>Каждый сигнал содержит 3 строчек:</p>
